...
fun AnimeScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        // Genre 16 = Animation
        fetch(tmdbService.discoverTv(apiKey, "16", "popularity.desc"), "Popular Anime")
        fetch(tmdbService.discoverMovies(apiKey, "16", "popularity.desc"), "Anime Movies")
        fetch(tmdbService.discoverTv(apiKey, "16", "vote_average.desc"), "Top Rated Anime")
        fetch(tmdbService.discoverMovies(apiKey, "16", "vote_average.desc"), "Top Rated Anime Movies")
        // Sub-genres: Animation + Action=10759, Animation + Comedy=35, Animation + SciFi=10765
